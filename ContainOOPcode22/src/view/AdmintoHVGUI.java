...
public class AdmintoHVGUI extends JFrame {
	...
	public AdmintoHVGUI() {
        ...
        btn_showDS.setBounds(727, 10, 195, 55);
        contentPane.add(btn_showDS);
        
        btn_TimKiem = new JButton("Tìm kiếm học viên");
        btn_TimKiem.setBounds(727, 111, 195, 55);
        contentPane.add(btn_TimKiem);
        
        btn_Xoa = new JButton("Xóa học viên");
        btn_Xoa.setBounds(727, 214, 195, 55);
        contentPane.add(btn_Xoa);
       
        btn_Them = new JButton("Thêm học viên");
        btn_Them.setBounds(727, 305, 195, 55);
        contentPane.add(btn_Them);
        
        btn_fixInfo = new JButton("Chỉnh sửa thông tin");
        btn_fixInfo.setBounds(727, 396, 195, 55);
        contentPane.add(btn_fixInfo);
        
        btn_Back = new JButton("Quay lại");
        btn_Back.setBounds(727, 491, 195, 55);
