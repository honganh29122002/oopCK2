...
public class HocVienDialog extends JDialog {
    ...
    public enum Mode { THEM, CHINH_SUA }

    public HocVienDialog(JFrame parent, Mode mode, String maHV, String tenHV, Date ngaySinh, String email) {
        ...
        if (mode == Mode.CHINH_SUA) tfMaHV.setEditable(false);
        add(tfMaHV);
    ...
    public HocVienDialog(JFrame parent) {
        this(parent, Mode.THEM, null, null, null, null);
    }
    ...
    public String getMaHV() {
        return tfMaHV.getText().trim();
    }

    public String getTenHV() {
        return tfTenHV.getText().trim();
    }

    public String getNgaySinh() {
        return tfNgaySinh.getText().trim();
    }
